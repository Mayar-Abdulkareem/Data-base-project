...
public class MyCartController implements Initializable {
    ...
    public void orderProducts(){
           ...
           try{
               ...
               if (flag == true){
                   date = getDate();
                   finalDate = "TO_DATE('" + date + "','YYYY-MM-DD')";
                   ...
                   order = "insert into orders values(oid.nextVal,"+LogOutController.cartID+",0,0,0,"+finalDate+","+total+")";
                   System.out.println(total);
                   ...
                   String newCart = "insert into cart values (CID.nextVAL,"+LogOutController.userID+")";
