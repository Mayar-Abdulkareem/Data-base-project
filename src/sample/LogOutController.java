            ...
            try {
                ...
                try {
                    ...
                    if (rs.getInt(1)!=0)
                        ...
                        String insertStr = "insert into Customer values(USERID.nextVal," +"'"+fName.getText() + "'," + "'"+lName.getText() + "'," + "'"+city.getText()
                        ...
                        String createCart= "insert into cart values (CID.nextVAL,UserID.CURRVAL)";
