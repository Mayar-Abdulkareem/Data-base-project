...
public class ProfileController implements Initializable {
    ...
    @FXML
    private TextField firstName,lastName,phone,city,street,near,email,password;
    @FXML
    ...
    public void save(ActionEvent event) throws IOException {
       ...
       // Connection connect = u.mySQLConnect();
        if(firstName.getText().isEmpty()||lastName.getText().isEmpty()||city.getText().isEmpty()||street.getText().isEmpty()
            ...
            try {
                String saveStm = "update Customer set FName = '" + firstName.getText()+"'"+"," + "LName = '"+lastName.getText()+"'"+","+ "City = '"+city.getText()+"'"+","+"Street = '"+street.getText()+"'"+","+
                        ...
                        +"where UserId ="+String.valueOf(CustomerID) ;
    ...
    public void initialize (URL url, ResourceBundle resourceBundle) {
        CustomerID = LogOutController.userID ;
        Unit u = new Unit();
        LocalDate date ;
       ...
       //     Connection con = u.mySQLConnect();
            ...
            String searchStr = "select FName , LName ,City , Street , Near , PNumber ,to_char(BDate,'yyyy-mm-dd') , Email , userPassword From Customer where UserID =" + CustomerID;
